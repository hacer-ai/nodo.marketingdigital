...
st.set_page_config(
    page_title="Nodo + Marketing Digital",
    page_icon="🧠",
...
st.sidebar.title("Nodo + Marketing Digital")
st.sidebar.divider()
st.sidebar.markdown("Mentor Marketing Digital", unsafe_allow_html=True)
st.sidebar.markdown("hacer Agent Toolkit 1.0")
st.sidebar.divider()

st.write("""<img height="120" src="https://es.nodoeafit.com/wp-content/uploads/2024/10/marketing-digital.png"/>""", unsafe_allow_html=True)
